jsPlumb.ready(function () {
    ...
    var initNode = function (el) {
        ...
        instance.makeSource(el, {
            filter: ".ep", // 相当于事件委托，如果不加filter，当连接数到达最多时，会有bug
            anchor: "Continuous",
            connectorStyle: {
                stroke: "#5c96bc",
                strokeWidth: 2,
    ...
    var newNode = function (x, y) {
        ...
        d.className = "w";
        d.id = id;
        d.innerHTML = id.substring(0, 7) + "<div class=\"ep\"></div>"; // 这里拼接可以用字符串拼接 `<div class="ep"></div>`
        d.style.left = x + "px";
        d.style.top = y + "px";
    ...
    instance.batch(function () {
        for (var i = 0; i < windows.length; i++) { // windows 是index.html中div的数量
            // 这里的true是深复制?? 没搞懂
